...
final class CoreDataStorage {
    ...
    private lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "TodayToday", withExtension: "momd")!
    ...
    private lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.thesoildsnake.com")!
        let url = directory.appendingPathComponent("TodayToday.sqlite")
        do {
